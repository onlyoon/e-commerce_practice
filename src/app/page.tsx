    ...
    <div className="bg-slate-50">
          ...
          <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              ...
              <p className='mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap' >
                Capture your favborite memories with your own, <span className='font-semibold' >one-of-one</span> phone case.
                CaseCobra allows you to prootect your memories, not just your phone case.
              </p>
      ...
      <section className='bg-slate-100 py-24'>
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-cool lg:flex-row items-center gap-4 sm:gap-6'>
            <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>What our{' '} <span className='relative px-2'>customers{' '}<Icons.underline className='hidden sm:block pointer-event-none absolute inset-x-0 -bottom-6 text-green-600' /></span>{' '}say</h2>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                <img className='rounded-full h-12 w-12 object-over' src='/users/user-1.png' alt='user' />
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                <img className='rounded-full h-12 w-12 object-over' src='/users/user-4.jpg' alt='user' />
                <div className='flex flex-col'>
